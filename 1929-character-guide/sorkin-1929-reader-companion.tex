...
publisher copy, book reviews, press interviews, and reader/study-guide summaries ---
rather than from the text of \emph{1929} itself, and every claim below is cited to one
of those public sources in the References section. Because the goal is to help a
listener keep names straight, character and institution sketches describe who people
\emph{were} and how they connect to one another; they deliberately omit how each
person's individual story concludes. Sorkin structures the book itself as a long
sequence of date-headed chapters (beginning February 1, 1929) within two parts, rather
than as topically titled chapters \autocite{wikipedia1929book}. Two reader-facing
tables of contents were suggested for this revision --- ursummary.com's chapter-by-
chapter breakdown and VitalSource's product listing --- but both were unreachable from
this document's authoring environment, so the chapter outline below instead follows
the numbered chapter groupings (Prologue; Part 1, Chapters 1--8, 9--17, and 18--25;
Part 2, Preface--Chapter 33; and Part 2, Chapter 34--Afterword) used by SuperSummary's
published study guide \autocite{ursummaryChapters1929,vitalsource1929,
supersummaryPrologueCh8,supersummaryCh9to17,supersummaryCh18to25,
supersummaryCh34Afterword}. This document is not authorized, reviewed, or endorsed by
...
\emph{The book's actual chapters are identified by date rather than by title, so the
entries below group them the way SuperSummary's published study guide does ---
Prologue; Part 1, Chapters 1--8, 9--17, and 18--25; and Part 2, Preface--Chapter 33
and Chapter 34--Afterword --- as the closest verifiable, publicly available proxy for
a table of contents \autocite{supersummaryPrologueCh8,supersummaryCh9to17,
supersummaryCh18to25,supersummaryCh34Afterword}. Each entry stays conceptual and
omits how any individual character's story resolves.}
